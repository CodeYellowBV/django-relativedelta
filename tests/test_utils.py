...
class ParseRelativedeltaTest(TestCase):
    ...
    def test_simple_parse_timedelta(self):
        ...
        self.assertStrictEqual(relativedelta(seconds=2, microseconds=300000.0), parse_relativedelta(timedelta(seconds=2.3)))
        self.assertStrictEqual(relativedelta(days=11, hours=18, minutes=11,
                                       seconds=50, microseconds=100010),
                         parse_relativedelta(timedelta(weeks=1, days=4.5, hours=5,
                                                       minutes=70.5, seconds=80.100005, microseconds=5))
                         )

    def test_normalize_timedelta(self):
        self.assertStrictEqual(relativedelta(seconds=21, microseconds=600000.0),
    ...
    def test_parse_iso8601csv(self):
        ...
        self.assertStrictEqual(relativedelta(years=1925, months=9, days=-14,
...
class CSVFormatTest(TestCase):
    def test_csv_conversions(self):
        self.assertEqual(relativedelta_as_csv(relativedelta(years=1925, months=9, days=-4,
                                                            hours=-12, minutes=27, seconds=54,
                                                            microseconds=-123456)),
                         '01925/009/-04 -12:027:054.-123456')
        self.assertEqual(parse_relativedelta('01925/009/-04 -12:027:054.-123456'),
        ...
        self.assertEqual(parse_relativedelta('-1925/009/-04 -12:027:-54.0123456'),
                         relativedelta(years=-1925, months=9, days=-4,
                                       hours=-12, minutes=27, seconds=-54,
                                       microseconds=123456)
                         )